...
3. **Tries something new** — introduce ONE meaningful change (new signal weighting, sector analysis, momentum detection, etc.)
4. **Implements the interface** — must subclass Strategy with analyze() and describe()
...
class EvolutionEngine:
    ...
    def evolve(self, current_strategy: Strategy, current_code: str) -> dict:
        ...
        try:
            ...
            return {"evolved": False, "new_code": None, "new_version": None, "reason": f"API error: {e}"}
        ...
        try:
            ...
            return {"evolved": False, "new_code": new_code, "new_version": None, "reason": f"Load failed: {e}"}
